<template>
    <div class="bg" >
        <div class="img_box">
            <img src="src/assets/images/ultraman/Ultraman-min-1k.jpg" width="fullWidth"/>
        </div>
    </div>
</template>
<script>
    export default {
        ...
        methods:{
            handleResize(event){
                this.fullWidth = (window.innerWidth || document.documentElement.clientWidth || document.body.clientWidth) - 16
                this.fullHeight = (window.innerWidth || document.documentElement.clientWidth || document.body.clientWidth) - 16
...
<style>
    ...
    .login-ultraseven-bg{
        background: url(src/assets/images/ultraman/UltraSeven-min-4k.jpg) center center no-repeat;
        background-size: cover;
        /*left: 10%;*/
        /*top: 50%;*/
        /*margin-top:-200px;*/
    ...
    .login-ultraman-bg{
        background: url(src/assets/images/ultraman/Ultraman-min-4k.jpg) center center no-repeat;
